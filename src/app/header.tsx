...
import { Avatar, AvatarFallback, AvatarImage } from '@/components/navbar/ui/avatar';
...
import {
  ...
  DropdownMenuTrigger,
} from '@/components/navbar/ui/dropdown-menu';
...
export default function Header() {
  ...
  return (
    <header className="flex items-center h-16 px-4 border-b shrink-0 md:px-6 justify-between">
        <div className='flex'>
            {/* Mudar a imagem da logo ou nao utilizar ela */}
        <Image src={travelerLogo} width={45} height={45} alt={''} className=' border bg-gray-200 rounded-full'/> 
